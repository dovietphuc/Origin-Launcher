...
public class UserEventDispatcher implements ResourceBasedOverride {
    ...
    public void logAppLaunch(View v, Intent intent, @Nullable UserHandle userHandle) {
        ...
        Action action = newTouchAction(0);
    ...
    public void logNotificationLaunch(View v, PendingIntent intent) {
        LauncherEvent event = newLauncherEvent(newTouchAction(0),
                newItemTarget(v, mInstantAppResolver), newTarget(3));
        Target itemTarget = newItemTarget(v, mInstantAppResolver);
        ArrayList<Target> targets = makeTargetsList(itemTarget);
    ...
    public void logActionCommand(int command, View itemView, int srcContainerType) {
        LauncherEvent event = newLauncherEvent(newCommandAction(command),
                newItemTarget(itemView, mInstantAppResolver), newTarget(3));
    ...
    public void logActionBounceTip(int containerType) {
        LauncherEvent event = newLauncherEvent(newAction(3),
    ...
    public void logDeepShortcutsOpen(View icon) {
        ...
        dispatchUserEvent(newLauncherEvent(newTouchAction(0), targets), null);
    ...
    public void logDragNDrop(DropTarget.DragObject dragObj, View dropTargetAsView) {
        ...
        LauncherEvent event = newLauncherEvent(newTouchAction(2), srcTargets);
    ...
    public void logActionBack(boolean completed, int downX, int downY, boolean isButton,
        ...
        int actionTouch = isButton ? 0 : 3;
        Action action = newCommandAction(actionTouch);
        action.command = 1;
        action.dir = isButton ? 0 :
                gestureSwipeLeft ? 3 : 4;
        Target target = newControlTarget(isButton ? 11 :
                19);
        target.spanX = downX;
        target.spanY = downY;
